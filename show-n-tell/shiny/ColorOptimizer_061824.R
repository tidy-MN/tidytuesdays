...
colors_palettes_fuct <- function(numIndividuals){
  ...
  ##FROM PALETTEER -- need to add as options to the palette drop down
  #https://cran.r-project.org/web/packages/paletteer/readme/README.html
  #example how to pull:
  # paletteer_c("scico::berlin", n = 10) ###see if where this palette is in the list...
  # paletteer_d("nord::frost")
  # paletteer_dynamic("cartography::green.pal", 5)
  #The cartography max over 10
  # paletteer_dynamic("cartography::blue.pal ", numIndividual),
  # paletteer_dynamic("cartography::orange.pal ", numIndividual),
  # paletteer_dynamic("cartography::red.pal ", numIndividual),
  # paletteer_dynamic("cartography::brown.pal ", numIndividual),
  # paletteer_dynamic("cartography::green.pal ", numIndividual),
  # paletteer_dynamic("cartography::purple.pal ", numIndividual),
  # paletteer_dynamic("cartography::pink.pal ", numIndividual),
  # paletteer_dynamic("cartography::wine.pal ", numIndividual),
  # paletteer_dynamic("cartography::grey.pal ", numIndividual),
  # paletteer_dynamic("cartography::turquoise.pal ", numIndividual),
  # paletteer_dynamic("cartography::sand.pal ", numIndividual),
  # paletteer_dynamic("cartography::taupe.pal ", numIndividual),
  # paletteer_dynamic("cartography::kaki.pal ", numIndividual),
  # paletteer_dynamic("cartography::harmo.pal ", numIndividual),
  # paletteer_dynamic("cartography::pastel.pal ", numIndividual),
  # paletteer_dynamic("cartography::multi.pal ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::qualitative ", numIndividual)
  #below max at 8 - did not use
  # paletteer_dynamic("ggthemes_solarized::yellow ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::orange ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::red ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::magenta ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::violet ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::blue ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::cyan ", numIndividual),
  # paletteer_dynamic("ggthemes_solarized::green ", numIndividual)
  # need to continue coding below
  # c
  # paletteer_c("ggthemes::Blue-Green Sequential", numIndividual),
  # paletteer_c("ggthemes::Blue Light", numIndividual),
  # paletteer_c("ggthemes::Orange Light", numIndividual),
  # paletteer_c("ggthemes::Blue", numIndividual),
  # paletteer_c("ggthemes::Orange", numIndividual),
  # paletteer_c("ggthemes::Red", numIndividual),
  # paletteer_c("ggthemes::Purple", numIndividual),
  # paletteer_c("ggthemes::Brown", numIndividual),
  # paletteer_c("ggthemes::Gray", numIndividual)
  # d
  # paletteer_d("awtools::bpalette"),
  # paletteer_d("awtools::brutal"),
  # paletteer_d("awtools::clean"),
  # paletteer_d("awtools::dark"),
  # paletteer_d("awtools::deepblue")
  # #max 9 
  ...
  #Max 8 - set2,pastel2,dark2,accent
  #max 9 - set1,pastel1 and some others in brewer (removed from the first palette list)
  if(numIndividuals==10){
    colors_palettes <- list(
      ...
      "Paletteer_Misc" = list(
        "Blue_Carto" = paletteer_dynamic("cartography::blue.pal ",numIndividuals),
        "Orange_Carto" = paletteer_dynamic("cartography::orange.pal ",numIndividuals),
        "Red_Carto" = paletteer_dynamic("cartography::red.pal ",numIndividuals),
        "Brown_Carto" = paletteer_dynamic("cartography::brown.pal ",numIndividuals),
        "Green_Carto" = paletteer_dynamic("cartography::green.pal ",numIndividuals),
        "Purple_Carto" = paletteer_dynamic("cartography::purple.pal ",numIndividuals),
        "Pink_Carto" = paletteer_dynamic("cartography::pink.pal ",numIndividuals),
        "Wine_Carto" = paletteer_dynamic("cartography::wine.pal ",numIndividuals),
        "Grey_Carto" = paletteer_dynamic("cartography::grey.pal ",numIndividuals),
        "Turquoise_Carto" = paletteer_dynamic("cartography::turquoise.pal ",numIndividuals),
        "Sand_Carto" = paletteer_dynamic("cartography::sand.pal ",numIndividuals),
        "Taupe_Carto" = paletteer_dynamic("cartography::taupe.pal ",numIndividuals),
        "Kaki_Carto" = paletteer_dynamic("cartography::kaki.pal ",numIndividuals),
        "Harmo_Carto" = paletteer_dynamic("cartography::harmo.pal ",numIndividuals),
        "Pastel_Carto" = paletteer_dynamic("cartography::pastel.pal ",numIndividuals),
        "Multi_Carto" = paletteer_dynamic("cartography::multi.pal ",numIndividuals),
        "BlueGreen Seq_GGthemes" = paletteer_c("ggthemes::Blue-Green Sequential",numIndividuals),
        "Blue Light_GGthemes" = paletteer_c("ggthemes::Blue Light",numIndividuals),
        "Orange Light_GGthemes" = paletteer_c("ggthemes::Orange Light",numIndividuals),
        "Blue_GGthemes" = paletteer_c("ggthemes::Blue",numIndividuals),
        "Orange_GGthemes" = paletteer_c("ggthemes::Orange",numIndividuals),
        "Red_GGthemes" = paletteer_c("ggthemes::Red",numIndividuals),
        "Purple_GGthemes" = paletteer_c("ggthemes::Purple",numIndividuals),
        "Brown_GGthemes" = paletteer_c("ggthemes::Brown",numIndividuals),
        "Gray_GGthemes" = paletteer_c("ggthemes::Gray",numIndividuals)
      ))
  }else if(numIndividuals==9){
    colors_palettes <- list(
      "Viridis" = list(
        "viridis" = viridis_pal(option = "viridis")(numIndividuals),
        "magma" = viridis_pal(option = "magma")(numIndividuals),
...
observe({
  lapply(1:input$clrcnt, function(i){
        print("Ln 689")
        print(reactive_values$palettespicked)
